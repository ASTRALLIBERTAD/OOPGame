...
pub fn cluster_decoration(
    ...
    let sp_idx = cell_hash(
        anchor_x,
        anchor_y,
        world_seed.wrapping_add(ANCHOR_SPECIES_SEED_OFFSET),
    ) as usize
        % species.len();
    ...
    let thin_roll = cell_hash(cell_x, cell_y, world_seed.wrapping_add(DECOR_SEED_OFFSET)) as f32
        / u32::MAX as f32;
